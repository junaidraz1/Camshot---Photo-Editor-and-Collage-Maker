...
class GalleryAlbumAdapter(
    ...
    override fun getView(i: Int, view: View?, viewGroup: ViewGroup): View {
        ...
        if (mView == null) {
            ...
            viewHolder.thumbnailView = mView!!.findViewById(R.id.thumbnailView) as ImageView
            viewHolder.titleView = mView.findViewById(R.id.titleView) as TextView
            viewHolder.itemCountView = mView.findViewById(R.id.itemCountView) as TextView
