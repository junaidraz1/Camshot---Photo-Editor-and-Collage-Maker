...
import com.miczon.photoeditor.eventListeners.ActionSheetClickListener;
import com.miczon.photoeditor.eventListeners.DialogClickListener;
...
public class DialogHandler {
    ...
    public void showSaveDialog(Context context, boolean isCancelable, String from, DialogClickListener dialogClickListener) {
        AlertDialog.Builder dialog = new AlertDialog.Builder(context);
        LayoutInflater factory = LayoutInflater.from(context);

        final View dialogView = factory.inflate(R.layout.layout_dialog_save, null);
        ...
        LinearLayout editLayout = dialogView.findViewById(R.id.ll_exit);
        LinearLayout continueLayout = dialogView.findViewById(R.id.ll_continue);

        if (from.equalsIgnoreCase("editImage")) {
        ...
        editLayout.setOnClickListener(v -> dialogClickListener.onButtonClick("0", "", "", alertDialog));
    ...
    public AlertDialog showSaveLayout(Context context, boolean isCancelable) {
        AlertDialog.Builder dialog = new AlertDialog.Builder(context);
        LayoutInflater factory = LayoutInflater.from(context);
...
*/
    ...
    public AlertDialog filterProgress(Activity activity, String title, String body, String from, int size, AlertDialog existingDialog) {
        AlertDialog.Builder dialog = new AlertDialog.Builder(activity, R.style.DialogTheme2);
        LayoutInflater factory = LayoutInflater.from(activity);
        ...
        FrameLayout nativeAdContainer = dialogView.findViewById(R.id.native_ad_container);
    ...
    public void revertChangeDialog(Context context, boolean isCancelable, DialogClickListener dialogClickListener) {
        AlertDialog.Builder dialog = new AlertDialog.Builder(context);
        LayoutInflater factory = LayoutInflater.from(context);

        final View dialogView = factory.inflate(R.layout.layout_dialog_reset_edit, null);
        ...
        LinearLayout cancelLayout = dialogView.findViewById(R.id.ll_exit);
        LinearLayout confirmLayout = dialogView.findViewById(R.id.ll_continue);

        cancelLayout.setOnClickListener(v -> dialogClickListener.onButtonClick("0", "", "", alertDialog));

        confirmLayout.setOnClickListener(v -> dialogClickListener.onButtonClick("1", "", "", alertDialog));
    ...
    public void exitDialog(Activity activity, boolean isCancelable, DialogClickListener dialogClickListener) {
        ...
        final View dialogView = factory.inflate(R.layout.layout_dialog_exit, null);
        ...
        LinearLayout cancelLayout = dialogView.findViewById(R.id.ll_exit);
        LinearLayout confirmExitLayout = dialogView.findViewById(R.id.ll_confirmExit);
//        FrameLayout adContainer = dialogView.findViewById(R.id.fl_adContainer);
//        TextView tvLoadingAd = dialogView.findViewById(R.id.tv_loadingAd);
...
//        }
        ...
        confirmExitLayout.setOnClickListener(v -> dialogClickListener.onButtonClick("1", "", "", alertDialog));
    ...
    public void showAgreementDialog(Context context, boolean isCancelable, DialogClickListener dialogClickListener) {
        ...
        final View dialogView = factory.inflate(R.layout.layout_dialog_user_agreement, null);
        ...
        Button btnAccept = dialogView.findViewById(R.id.btn_continue);
...
//        LinearLayout unifiedAdLayout = bottomSheetDialog.findViewById(R.id.ll_unified_ad_layout);
        ...
        if (rightLayout != null && leftLayout != null && buttonLayout != null && singleButtonLayout != null &&
                ...
                progressBar != null && progressBar2 != null && nativeAdContainer != null && adaptiveLayout != null &&
                adContainer != null && tvLoadingAd != null && nativeAdView != null) {
...
//                }
                ...
                nativeAdHelper.showAdMobNativeBannerAd(nativeAdView, nativeAdContainer, "ca-app-pub-3940256099942544/2247696110");
            }

            tvTitle.setText(title);
            tvMessage.setText(messageBody);
            if (isFrom.equalsIgnoreCase("loadingFilters")) {
                progressBar.setVisibility(View.VISIBLE);
